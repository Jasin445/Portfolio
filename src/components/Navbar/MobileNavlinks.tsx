...
const MobileNavlinks: React.FC<MobileProps> = ({
  ...
  return (
    <section
      className={cn(
        `px-4 md:hidden fixed h-[calc(100vh-65px)] top-[65px] py-14  w-full left-0 bg-background z-30 transform transition-all duration-1000 ease-in-out flex flex-col items-center`,
        {
